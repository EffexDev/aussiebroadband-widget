...
ProcessSuperlookup(*)
{
    ...
    ;Australia Post T/Ns
    else if (RegExMatch(A_Clipboard, "(?:R|92A|34ECK|I8|2KUZ|34TDC|36AAC|36BRU|36LFM|36LDQ|030|0207|47U4|4GPZ|4HBZ|S1KZ)\d+", &Match))
...
UpdateWidget(*) {
    ...
    LoadingGui["MyProgress"].Value := 80
    Sleep "500"
    LoadingGui["MyProgress"].Value := 65
    Sleep "500"    
